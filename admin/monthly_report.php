          ...
          <div class="col-md-12 ">
            <div class="card">
              ...
              <?php   
              		...
              		// $fromDate = date("Y-m-d", strtotime($currentDate . '+10 day'));
                ...
                //MONTH to get current month of the date
                //YEAR to get current year of the date
                $stmt = $pdo->prepare("SELECT * FROM sale_order WHERE MONTH(order_date)=MONTH(now()) AND YEAR(order_date)=YEAR(now())");
                $stmt->execute();
                $result = $stmt->fetchAll();
              ?>
              <!-- /.card-header -->
