          ...
          <div class="col-md-12 ">
            <div class="card">
              ...
              <?php   
                ...
                $stmt = $pdo->prepare("SELECT * FROM sale_order_detail WHERE sale_order_id= $id LIMIT $offset,$numOfrecs");
                $stmt->execute();
                ...
                <table class="table table-bordered">
                 ...
                 <nav aria-label="Page navigation example" style="float:right;">
                  <ul class="pagination">
                    ...
                    <li class="page-item <?php if($pageno >= $total_pages){echo 'disabled';} ?>"><a class="page-link" href="<?php if($pageno >= $total_pages){ echo '#'; }else {echo "?id=".$_GET['id']."&pageno=".($pageno+1);} ?>">Next</a></li>
